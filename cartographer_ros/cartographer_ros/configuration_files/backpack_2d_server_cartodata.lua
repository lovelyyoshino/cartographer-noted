...
options ={
  ...
  use_landmarks = true,
  num_laser_scans = 0, --0
  num_multi_echo_laser_scans = 1, --1
  ...
  time_delay_for_relocalization = 0.8,
  time_delay_for_finish_trajectory = 0.5,
  time_delay_for_delete_trajectory = 0.5,
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.intensity_space_weight = 1. --1.
...
MAP_BUILDER.pose_graph.optimize_every_n_nodes = 45 --90
...
MAP_BUILDER.pose_graph.constraint_builder.fast_correlative_scan_matcher.linear_search_window = 5 --7
...
MAP_BUILDER.pose_graph.constraint_builder.max_constraint_distance = 15 --15
...
MAP_BUILDER.pose_graph.has_overlapping_submaps_trimmer_2d = true --no this param
