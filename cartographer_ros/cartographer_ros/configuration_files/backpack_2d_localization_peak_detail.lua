...
POSE_GRAPH.global_constraint_search_after_n_seconds = 200 --10


POSE_GRAPH.constraint_builder.min_score = 0.55 --0.55
POSE_GRAPH.constraint_builder.max_constraint_distance = 6 --15
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.6 --0.6
POSE_GRAPH.constraint_builder.loop_closure_translation_weight = 1.1e1 --1.1e4
POSE_GRAPH.constraint_builder.loop_closure_rotation_weight = 1e1 --1e5
