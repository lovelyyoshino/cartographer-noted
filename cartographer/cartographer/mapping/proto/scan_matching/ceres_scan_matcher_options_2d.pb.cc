...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_cartographer_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f2d_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::cartographer::mapping::scan_matching::proto::CeresScanMatcherOptions2D, intensity_space_weight_),
...
const char descriptor_table_protodef_cartographer_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f2d_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "_options.proto\"\334\001\n\031CeresScanMatcherOptio"
  "ns2D\022\035\n\025occupied_space_weight\030\001 \001(\001\022\032\n\022t"
  "ranslation_weight\030\002 \001(\001\022\027\n\017rotation_weig"
  "ht\030\003 \001(\001\022\036\n\026intensity_space_weight\030\004 \001(\001"
  "\022K\n\024ceres_solver_options\030\t \001(\0132-.cartogr"
  "apher.common.proto.CeresSolverOptionsb\006p"
  "roto3"
  ;
...
CeresScanMatcherOptions2D::CeresScanMatcherOptions2D(const CeresScanMatcherOptions2D& from)
  ...
  ::memcpy(&occupied_space_weight_, &from.occupied_space_weight_,
    static_cast<size_t>(reinterpret_cast<char*>(&intensity_space_weight_) -
    reinterpret_cast<char*>(&occupied_space_weight_)) + sizeof(intensity_space_weight_));
...
void CeresScanMatcherOptions2D::SharedCtor() {
  ...
  ::memset(&ceres_solver_options_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&intensity_space_weight_) -
      reinterpret_cast<char*>(&ceres_solver_options_)) + sizeof(intensity_space_weight_));
}
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 33)) {
          intensity_space_weight_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* CeresScanMatcherOptions2D::_InternalSerialize(
  ...
  // double intensity_space_weight = 4;
  if (!(this->intensity_space_weight() <= 0 && this->intensity_space_weight() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(4, this->_internal_intensity_space_weight(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:cartographer.mapping.scan_matching.proto.CeresScanMatcherOptions2D)
  ...
  if (!(from.intensity_space_weight() <= 0 && from.intensity_space_weight() >= 0)) {
    _internal_set_intensity_space_weight(from._internal_intensity_space_weight());
  }
}
...
void CeresScanMatcherOptions2D::InternalSwap(CeresScanMatcherOptions2D* other) {
  ...
  swap(intensity_space_weight_, other->intensity_space_weight_);
}
